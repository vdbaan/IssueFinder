...
public interface PredicateListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code notColumn}
	 * labeled alternative in {@link PredicateParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterNotColumn(PredicateParser.NotColumnContext ctx);
	/**
	 * Exit a parse tree produced by the {@code notColumn}
	 * labeled alternative in {@link PredicateParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitNotColumn(PredicateParser.NotColumnContext ctx);
	/**
