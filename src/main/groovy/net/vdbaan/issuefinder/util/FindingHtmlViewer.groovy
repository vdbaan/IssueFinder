...
<tr><td width='15%' style='border:1px solid black;'><b>Source</b></td><td style='border:1px solid black;'>${
            finding.ip
        }:${finding.port}(${finding.protocol}/${finding.portStatus})</td></tr>
<tr><td width='15%' style='border:1px solid black;'><b>Hostname</b></td><td style='border:1px solid black;'>${
            finding.hostName
        }</td></tr>
<tr><td width='15%' style='border:1px solid black;'><b>Service</b></td><td style='border:1px solid black;'>${
            finding.service
        }</td></tr>
<tr><td width='15%' style='border:1px solid black;'><b>Plugin/Version</b></td><td style='border:1px solid black;'>${
            finding.plugin
        }</td></tr>
<tr><td width='15%' style='border:1px solid black;'><b>Severity</b></td><td style='border:1px solid black;${
            getSeverityStyle(finding)
        }'>${finding.severity}</td></tr>
<tr><td width='15%' style='border:1px solid black;'><b>CVSS Base Score</b></td><td style='border:1px solid black;'>${
            finding.baseCVSS
        }</td></tr>
<tr><td width='15%' style='border:1px solid black;'><b>CVSS Base Vector</b></td><td style='border:1px solid black;'>${
            finding.cvssVector
        }</td></tr>
